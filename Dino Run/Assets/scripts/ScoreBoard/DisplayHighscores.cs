...
public class DisplayHighscores : MonoBehaviour 
{
    ...
    public TMPro.TextMeshProUGUI[] yourName;
    public TMPro.TextMeshProUGUI[] yourScore;
    HighScores myScores;
    ...
    public void SetScoresToMenu(PlayerScore[] highscoreList) //Assigns proper name and score for each text value
    {
        ...
        {
            if (highscoreList[i].username == SendToGoogle.Name)
            {
                yourScore[0].text = highscoreList[i].score.ToString();
                yourName[0].text = i + 1 + ". " + highscoreList[i].username;
            }
        }
    }
